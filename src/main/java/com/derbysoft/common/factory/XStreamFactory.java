...
public abstract class XStreamFactory {
    ...
    public static XStream create() {
        ...
        xStream.registerConverter(new SerializableConverter(xStream.getMapper(), xStream.getReflectionProvider(), new ClassLoaderReference(ClassLoader.getSystemClassLoader())), XStream.PRIORITY_LOW + 2);
        return xStream;
    }
