package com.derbysoft.common.log4j;
...
public class DailyRollingFileAppender extends FileAppender {
    ...
    private TimeZone timeZone = TimeZone.getTimeZone(timeZoneID);

    private RollingCalendar rc = new RollingCalendar(timeZone, Locale.getDefault());
